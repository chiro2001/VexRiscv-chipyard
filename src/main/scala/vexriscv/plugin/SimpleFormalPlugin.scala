...
case class SimpleRvfiPort() extends Bundle with IMasterSlave {
  val valid = Bool
...
class SimpleFormalPlugin extends Plugin[VexRiscv]{

  var rvfi : SimpleRvfiPort = null


  override def setup(pipeline: VexRiscv): Unit = {
    rvfi = master(SimpleRvfiPort()).setName("rvfi")
  }
